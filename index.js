...
client.on("ready", async () => {
  console.log(`Luxury Moderator Bot Is Created By _$Lukas$_#4198`);
  client.user
    .setActivity(`By _$Lukas$_#4198`, { type: "PLAYING" })
...
modules.forEach(function(module) {
  fs.readdir(`./commands/${module}`, function(err, files) {
    ...
    files.forEach(function(file) {
      ...
      console.log(`${command.name} Příkaz byl úspěšně načten - ✅`);
